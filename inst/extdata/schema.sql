...
user_pinned_tweet_id VARCHAR,
user_name VARCHAR,
retweet_count INTEGER,
like_count INTEGER,
quote_count INTEGER,
user_tweet_count INTEGER,
user_list_count INTEGER,
user_followers_count INTEGER,
user_following_count INTEGER,
sourcetweet_type VARCHAR,
sourcetweet_id VARCHAR,
sourcetweet_text VARCHAR,
sourcetweet_lang VARCHAR,
sourcetweet_author_id VARCHAR,
